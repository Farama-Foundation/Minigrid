...
register(
    ...
    entry_point='pedgrid.envs.pedestrian:PedestrianEnv9x16'
)
        
register(
    id='Pedestrian-Empty-6x20-v0',
    entry_point='pedgrid.envs.pedestrian:PedestrianEnv6x20'
)

register(
    id='Pedestrian-Empty-20x80-v0',
    entry_point='pedgrid.envs.pedestrian:PedestrianEnv20x80'
)